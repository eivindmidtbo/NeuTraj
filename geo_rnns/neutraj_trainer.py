...
class NeuTrajTrainer(object):
    ...
    def neutraj_train(self, print_batch = 10, print_test = 100, save_model = True, load_model = None,
        ...
        if load_model != None:
            ...
            tm.test_model(self,embeddings, test_range=list(range(len(self.train_seqs), len(self.train_seqs)+config.test_num)),
                                 similarity=True, print_batch=print_test, r10in50=True)
        for epoch in range(config.epochs):
            ...
            acc1 = tm.test_model(self,embeddings, test_range=list(range(int(len(self.padded_trajs)*0.8),
